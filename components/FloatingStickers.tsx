...
export function FloatingStickers() {
  return (
    <>
      ...
      <div className="absolute top-4 right-2 sm:top-12 sm:right-4 md:top-20 md:right-8 z-0 pointer-events-none rotate-12">
      ...
      <div className="absolute bottom-4 left-80 sm:bottom-32 sm:left-8 md:top-4 md:bottom-auto md:left-32 z-0 pointer-events-none rotate-12">
      ...
      <div className="absolute top-1/3 left-4 z-0 pointer-events-none hidden lg:block">
      ...
      <div className="absolute top-8 right-1/4 sm:top-12 sm:right-1/3 md:top-16 z-0 pointer-events-none">
      ...
      <div className="absolute bottom-4 left-12 z-0 pointer-events-none hidden md:block">
      ...
      <div className="absolute bottom-2 right-4 sm:bottom-48 md:bottom-60 sm:right-8 md:right-16 z-0 pointer-events-none">
      ...
      <div className="absolute bottom-2 right-4 sm:bottom-28 sm:right-6 md:bottom-32 md:right-8 z-0 pointer-events-none -rotate-12">
      ...
      <div className="absolute bottom-2 left-1/4 sm:bottom-44 md:bottom-48 z-0 pointer-events-none">
      ...
      <div className="absolute bottom-2 left-8 sm:bottom-18 sm:left-12 md:bottom-20 md:left-20 z-0 pointer-events-none rotate-12">
      ...
      <div className="absolute top-8 left-1/4 sm:top-12 sm:left-1/5 md:top-20 md:left-1/6 z-0 pointer-events-none">
      ...
      <div className="absolute top-2/3 left-8 z-0 pointer-events-none hidden lg:block">
      ...
      <div className="absolute bottom-2 right-12 sm:top-36 sm:bottom-auto sm:right-20 md:top-40 md:right-32 z-0 pointer-events-none">
