...
export function Header({ className = "" }: HeaderProps) {
  return (
    <header className={`relative z-20 px-4 py-4 sm:py-6 md:py-8 ${className}`}>
      <div className="max-w-2xl mx-auto text-center">
        {/* Logo and Title with sparkle on the left */}
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-black tracking-tight font-sans relative inline-block animate-fade-in-up-bounce">
